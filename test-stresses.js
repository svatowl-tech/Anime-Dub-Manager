const stresses = {
  "Кономи Оконоги": "Коно́ми Оконо́ги",
  "Эдвард": "Э́двард",
  "Наруто": "Нару'то",
  "Саске": "САске",
  "Аска": "Аска́",
...
const texts = [
  "Привет, Кономи-тян! Как дела, Оконогу?",
  "Эдварда нигде нет. Я видел Эдвардом.",
  "Наруту нравится Саски.",
  "Аской было принято решение. Аску!",
  "Сильфией и Мэй.",
  "Оконогия не должно совпадать."
];
